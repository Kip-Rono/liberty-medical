...
(function () {
    ...
    null == window.__sharethis__ && (window.__sharethis__ = {
        ...
        return t.fcmp = "function" == typeof window.__cmp, t.product = e.product, t.publisher = e.property, t.source = "sharethis.html", null == t.title && (t.title = e.getTitle()), t.ts = Date.now(), t.sop = !0, t.consentData = e.consentData, t.consentDomain = e.consentDomain, e.send("https://l.sharethis.com/log?" + e.qs(t))
...
(function () {
    ...
    e = window.__sharethis__.img, s = /MSIE 8.0/.test(navigator.userAgent), window.__sharethis__.cdn = "https://platform-cdn.sharethis.com/", window.__sharethis__.ICONS = {
        arrow_left: e("arrow_left.html"),
        arrow_right: e("arrow_right.html"),
        blogger: e("blogger.html"),
        buffer: e("buffer.html"),
        close: e("close.html"),
        delicious: e("delicious.html"),
        diaspora: e("diaspora.html"),
        digg: e("digg.html"),
        douban: e("douban.html"),
        email: e("email.html"),
        evernote: e("evernote.svg"),
        facebook: e("facebook.svg"),
        flipboard: e("flipboard.html"),
        getpocket: e("pocket.html"),
        github: e("github.svg"),
        gmail: e("gmail.svg"),
...
(function () {
    ...
    n = window.__sharethis__, n.loader["share-all"] = function (t) {
        ...
        for (c += "</div>", O = "../s3.amazonaws.com/sharethis-socialab-prod/share-this-logo%402x.png", f = "https://sharethis.com/platform/share-buttons?" + n.qs({
...
(function () {
    ...
    if (a = window.__sharethis__, !a.loaded) {
        ...
        a.href = document.location.href, null == a.source && (a.source = "sharethis.html"), null == a.property && (a.property = "anonymous"), null == a.product && (a.product = "unknown"), i = a.product, d.call(a.PRODUCTS, i) < 0 && (a.product = "unknown"), a.initialize = function (n) {
...
"undefined" == typeof __stdos__.data && (__stdos__.data = {
        ...
        setRefDomain: function (t) {
            if (0 != t.length) {
                var e = t.replace("http://", "").replace("https:///", "").split("index.html");
                if (e.length > 0) {
...
(function () {
    ...
    e = window.__sharethis__, e.loader["gdpr-compliance-tool"] = function (n) {
        ...
        if (null == n && (n = {}), n.enabled && !window.__cmp) return o = n.color, a = n.display, t = n.publisher_name, c = n.publisher_purposes, l = n.scope, null == o && (o = "#2e7d32"), null == t && (t = ""), null == c && (c = []), r = [], e.addEventListener("message", function (e) {
            ...
            color: o
        }, "always" === a ? (__cmp("showConsentTool"), e.js("../c.sharethis.mgr.consensu.org/cmp.js")) : "eu" === a ? (s = new XMLHttpRequest, s.open("GET", "https://c.sharethis.mgr.consensu.org/is_eu"), s.responseType = "json", s.onload = function (n) {
            return function () {
                var n;
                if (null != (n = s.response) ? n.is_eu : void 0) return __cmp("showConsentTool"), e.js("../c.sharethis.mgr.consensu.org/cmp.js")
            }
        }(this), s.send()) : void 0
    }
}).call(this);
(function () {
    ...
    a = window.__sharethis__, a.loader["google-analytics"] = function (a) {
        ...
        }, window.ga.l = 1 * new Date, n = document.createElement("script"), e = document.getElementsByTagName("script")[0], n.async = 1, n.src = "../www.google-analytics.com/analytics.js", e.parentNode.insertBefore(n, e), ga("create", a.ga_id, "auto"), ga("send", "pageview")
    }
}).call(this);
(function () {
    var e;
